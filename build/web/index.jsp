            ...
            <header class="site-header">
                <div class="container">
                    ...
                    <div class="main-navigation">
                        ...
                        <ul class="menu">
                                <%
                                    String displayName = "", test = "", address = "";
                                    test = (String) session.getAttribute("displayName");
                                ...
                                %>
                            <li class="menu-item" style="background-color: #FFD700; padding: 21px 0; border-radius: 5px; color: black"><a href="<%=address%>"><%= displayName%></a></li>
                        </ul>
                    </div> <!-- .main-navigation -->
